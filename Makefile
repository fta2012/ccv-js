...
#CXXFLAGS += -v -g4 -s ASSERTIONS=1 -s DEMANGLE_SUPPORT=1 -Weverything -Wall -Wextra
...
build/ccv_with_filesystem.js: CXXFLAGS += -s NO_FILESYSTEM=0 -s FORCE_FILESYSTEM=1 --embed-file external/ccv/samples/face.sqlite3@face.sqlite3
